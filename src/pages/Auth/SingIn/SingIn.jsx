    ...
    <div className="flex items-center min-h-screen justify-center">
      <ConfigProvider theme={{
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-md p-6 space-y-4 bg-[#333] text-white rounded-lg shadow-md">
          ...
          <button className="cursor-pointer w-full px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Sign IN</button>
          <div className="flex justify-center items-center space-x-2">
            <p>Don't have an account</p>
            <Link to="/auth/sign-up" className="text-blue-600 hover:underline">Create Account</Link>
          </div>
        </div>
      </ConfigProvider>
    </div>
